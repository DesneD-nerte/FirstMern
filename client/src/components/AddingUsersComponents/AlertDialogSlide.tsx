...
export default function AlertDialogSlide(props: propsAlert) {
	...
	const handleDownload = () => {
		axios
			.get(`${endpoint}/files/getExcelTemplate`, {
	...
	return (
		<div>
			...
			>
				<DialogTitle>
					{"Необходимо загрузить Excel файл на обработку"}
				</DialogTitle>
				<DialogContent>
					<DialogContentText id="alert-dialog-slide-description">
						Скачайте шаблон файла, заполните необходимые поля один за одним.
						Поля логина и пароля сгенерируются автоматически
					</DialogContentText>
				</DialogContent>
				<DialogActions>
